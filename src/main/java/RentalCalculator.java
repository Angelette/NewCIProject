...
public class RentalCalculator {
	...
	public static double carRental(String carModel, int duration, boolean firstTimer, boolean member){
		...
		if (firstTimer){ //first rental
			if (carModel.equals("Honda Fit"))
				rentalFees = 65.0*duration*0.95; //honda fit
			else
				rentalFees = 80.0*duration*0.95; //toyota wish
		}
		else if (member){ //subsequent rental 
			...
			if(carModel.equals("Toyota Wish")) {
			rentalFees = 80.0*duration; //toyota wish
			}
			else {
				rentalFees = 65.0*duration; //honda fit
			}
		}
	...
	public static void main(String[] args) {
		...
		System.out.println("Honda, firsttime, 1D : " + RentalCalculator.carRental("Honda Fit", 1, false, true));
		System.out.println("Toyota, firsttime, 1D : " + RentalCalculator.carRental("Toyota Wish", 1, false, true));
		
		System.out.println("Honda, firsttime, 5D : " + RentalCalculator.carRental("Honda Fit", 5, false, false));
		System.out.println("Toyota, firsttime, 5D : " + RentalCalculator.carRental("Toyota Wish", 5, false, false));
		System.out.println("Honda, firsttime, 5D : " + RentalCalculator.carRental("Honda Fit", 5, false, true));
		System.out.println("Toyota, firsttime, 5D : " + RentalCalculator.carRental("Toyota Wish", 5, false, true));
